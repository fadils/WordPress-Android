 ...
 */
public class NosaraVolleyErrorHelper {

    public static synchronized void logVolleyErrorDetails(final VolleyError volleyError) {
        if (volleyError == null) {
            Log.e(NosaraClient.LOGTAG, "Tried to log a VolleyError, but the error obj was null!");
            return;
        }
        if (volleyError.networkResponse != null) {
            NetworkResponse networkResponse = volleyError.networkResponse;
            Log.e(NosaraClient.LOGTAG, "Network status code: " + networkResponse.statusCode);
            if (networkResponse.data != null) {
                Log.e(NosaraClient.LOGTAG, "Network data: " + new String(networkResponse.data));
            }
        }

        // TODO Log the headers here

        Log.e(NosaraClient.LOGTAG, "Volley Error details: " + volleyError.getMessage(), volleyError);
    }
