        ...
        if (data != null) {
            ...
            if (selectedContent != null && selectedContent.size() > 0) {
                ...
                if (localMediaAdded > 0) {
                    ...
                    analyticsProperties.put(mEditPostContentFragment.ANALYTIC_PROP_NUM_LOCAL_PHOTOS_ADDED, localMediaAdded);
                ...
                if (libraryMediaAdded > 0) {
                    Map<String, Object> analyticsProperties = new HashMap<>();
                    analyticsProperties.put(mEditPostContentFragment.ANALYTIC_PROP_NUM_WP_PHOTOS_ADDED, libraryMediaAdded);
